    ...
    <section className="container">
      <div className="row justify-content-center">
        <div className="col-sm-6"> 
          ...
          <p>Logan's been doing software engineering work for a while now, as it provides him with a skill set to design applications with a variety of technologies. During his free time you can find him, swing trading in the stock market, watching movies, coding his own projects, and learning new skills!</p>
